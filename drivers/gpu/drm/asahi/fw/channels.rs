...
pub(crate) trait RXChannelState: GPUStruct + Debug + Default {
    ...
    fn wptr<'a>(raw: &Self::Raw<'a>, index: usize) -> u32;
    fn set_rptr<'a>(raw: &Self::Raw<'a>, index: usize, rptr: u32);
}
...
impl RXChannelState for ChannelState {
    ...
    fn wptr<'a>(raw: &Self::Raw<'a>, _index: usize) -> u32 {
        raw.write_ptr.load(Ordering::Acquire)
    }

    fn set_rptr<'a>(raw: &Self::Raw<'a>, _index: usize, rptr: u32) {
...
pub(crate) trait TXChannelState: GPUStruct + Debug + Default {
    fn rptr<'a>(raw: &Self::Raw<'a>) -> u32;
    fn set_wptr<'a>(raw: &Self::Raw<'a>, wptr: u32);
}
